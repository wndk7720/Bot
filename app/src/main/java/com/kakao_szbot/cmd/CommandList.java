...
public class CommandList {
    ...
    public static String[][] BOT_BASIC_DEFAULT_MSG = {
            ...
            /* notification msg */
            {
                ...
                " - 오프라인 활동 위주\n" +
                " - 정모는 분기별로 진행 예정\n" +
                "   * 애니상영회, 엠티 등과 같은 컨텐츠로 진행\n" +
                "   * 1년에 3~4번 정도 다함께 모이는 날이므로 되도록 참여해주세요~\n" +
                ...
                " - 스포는 신작은 금지, 오래된 애니도 심각한 반전은 적당히\n" +
                " - 반말은 초면에 금지, 합의한 분들끼리만 (기본 예의라고 생각해요!)\n" +
                ...
                " - 번개 취소시에도 참여자들에게 양해 구한 후 취소\n" +
                " - 일정 약속시간보다 늦을 경우 미리미리 덧글 및 채팅방에 알려주기\n" +
                " - 혹시 큰 규모의 일정(신년회, 송년회, 엠티, 해외여행, 큰 행사 등)을 따로 열고 싶을 경우, 운영진과 따로 협의후 개설\n" +
                "   * 계획 중인 일정과 겹치지 않기 위함 및 모임 방향성 고려 필요!"
            },
            /* introduce msg */
            {
